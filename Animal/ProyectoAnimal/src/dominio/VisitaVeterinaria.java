...
public class VisitaVeterinaria extends Actividad implements Serializable {
    ...
    public VisitaVeterinaria(String nombre, LocalTime hora, Usuario responsable, Animal mascota, boolean fueRealizado, Fecha fecha, Veterinaria veterinaria, String motivo) {
        setNombre(nombre);
        this.hora = hora;
